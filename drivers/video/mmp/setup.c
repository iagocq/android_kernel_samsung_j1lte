 ...
 */
/* FB memory reservation, 0x1800000@0x17000000 by default */
...
static int __init mmp_fdt_find_fb_buf_num_info(unsigned long node, const char *uname,
		int depth, void *data)
{
	__be32 *prop;
	unsigned long len;
...
static int __init panel_setup(char *str)
{
	...
	if (of_scan_flat_dt(mmp_fdt_find_fb_info, NULL))
		...
		of_scan_flat_dt(mmp_fdt_find_fb_buf_num_info, NULL);
#endif
...
void __init pxa1908_reserve_fbmem(void)
{
