...
static struct mfp_addr_map pxa1908_addr_map[] __initdata = {
/*
...
/*
 * the following DVS gpios are from SM-J1100F_GPIO.xls
 * { offset in pxa1908_addr_map, gpio number, select PIN as GPIO function}
 */
	{0, 25, 6},
	{1, 26, 6},
	{2, 27, 6},
...
{
#ifdef CONFIG_SEC_GPIO_DVS
	mfp_init_addr(pxa1908_addr_map);
