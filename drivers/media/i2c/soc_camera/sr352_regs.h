 #ifndef SR352__REGS_H_                                                                                                                                        
 #define SR352__gREGS_H_
struct sr352_regval {
	u8 addr;
	u8 val;
};
...
struct sr352_resolution {
	int res_code;
	struct sr352_regval *regs_resolution;
};


static struct sr352_regval regs_flicker_60HZ_setting[] = {
	{0x03, 0x00},
	{0x01, 0x00},
	{0xff, 0x02},
...
//Shutter Setting
	...
	{SR352_TERM, SR352_TERM},
};

static struct sr352_regval regs_flicker_50HZ_setting[] = {
	{0x03, 0x00},
	{0x01, 0x00},
	{0xff, 0x02},
...
static struct sr352_regval regs_start_setting[] = {
///////////////////////////////////////////////////////////////////////////////
...
//OUTPUT: MIPI interface /////////////////////////////////////////
	{0x02, 0x07},		// pclk_drive = 00, 0x0b}, i2c_drive = 111b
	{0x0c, 0x07},		// d_pad_drive = 00, 0x0b}, gpio_pad_drive = 111b
//////////////////////////////////////////////////////////////////
...
//B Value 
	...
	{0x10, 0x01},	// LSC ON
	{0x11, 0x00}, //gap y o, 0xff}, gap x off
...
static struct sr352_regval regs_display_uyvy_setting[] = {
	{SR352_TERM, SR352_TERM},
};

#if 0
static struct sr352_regval regs_display_vyuy_setting[] = {
	{SR352_TERM, SR352_TERM},
};

static struct sr352_regval regs_display_yuyv_setting[] = {
	{SR352_TERM, SR352_TERM},
};

static struct sr352_regval regs_display_yvyu_setting[] = {
	{SR352_TERM, SR352_TERM},
};
#endif

static struct sr352_regval regs_stop_stream[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
	{0x03, 0x00},
...
static struct sr352_regval regs_start_stream[] = {
//	{0x03, 0x10},
//	{0x2f, 0x79}, 
	{SR352_TERM, SR352_TERM},
};

static struct sr352_regval regs_res_auto_fps[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_vga_cam[] = {
...
static struct sr352_regval regs_res_capture_vga[] ={
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
static struct sr352_regval regs_res_capture_800x480[] ={
...
///////////////////////////////////////////
	{0x03, 0x05},  // Page05
	{0x30, 0x06},  // l_pkt_wc_h  // Full = 800 * 2 (YUV)
...
static struct sr352_regval regs_res_capture_960x720[] ={
...
///////////////////////////////////////////
	{0x03, 0x05},  // Page05
	{0x30, 0x07},  // l_pkt_wc_h  // Full = 960 * 2 (YUV)
...
static struct sr352_regval regs_res_capture_1280x720[] ={
...
static struct sr352_regval regs_res_capture_1280x960[] ={
...
static struct sr352_regval regs_res_capture_1536x864[] ={
...
///////////////////////////////////////////
	{0x03, 0x05},  // Page05
	{0x30, 0xc0},  // l_pkt_wc_h  // Full = 1536 * 2 (YUV)
	{0x31, 0x00},  // l_pkt_wc_l
...
static struct sr352_regval regs_res_capture_1600x960[] ={
...
static struct sr352_regval regs_res_capture_1600x1200[] ={
...
static struct sr352_regval regs_res_capture_2048x1152[] ={
...
static struct sr352_regval regs_res_capture_2048x1232[] ={
...
static struct sr352_regval regs_res_capture_2048x1280[] ={
...
static struct sr352_regval regs_res_capture_2048x1536[] ={
...
static struct sr352_regval regs_res_preview_vga_enter[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_vga[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_720x480_enter[] ={
...
static struct sr352_regval regs_res_preview_720x480[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_800x480_enter[] =
{
...
static struct sr352_regval regs_res_preview_800x480[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_704x576_enter[] =
{
...
static struct sr352_regval regs_res_preview_704x576[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_1024x576_enter[] =
{
...
static struct sr352_regval regs_res_preview_1024x576[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval regs_res_preview_1024x640_enter[] =
{
...
static struct sr352_regval regs_res_preview_1024x768_enter[] =
{
...
static struct sr352_regval regs_res_preview_1024x768[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval  regs_res_preview_176x144[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval  regs_res_preview_320x240[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval  regs_res_preview_352x288[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval  regs_res_preview_528x432[] =
{
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
///////////////////////////////////////////
	...
	{0x30, 0x04},  // l_pkt_wc_h  // Pre = 528 * 2 (YUV)
...
static struct sr352_regval  regs_res_preview_800x600[] = {
	{0x03, 0xc8},	//AWB Off
	{0x10, 0x52},
...
/*============================================*/
static struct sr352_regval  regs_res_recording_HD[] = {
...
//Shutter Setting
	{0x03, 0xc7},
	{0x10, 0x30}, // AE Off (Band Off) 50hz , 0x30}, 60hz 10
	{0x12, 0x03}, // Slow AE
	{0x15, 0xc0}, // SSD Patch Weight Y Mean On
	...
	{0x03, 0xc7},
	{0x10, 0xb0},	//AE On (Band Off) 50hz , 0xb0}, 60hz 90
...
static struct sr352_regval  regs_res_recording_50Hz_HD[] = {
...
static struct sr352_regval  regs_res_recording_50Hz_modeoff[] = {
	{0x03, 0xc1},
	{0x10, 0x06}, // ssd tranfer disable
	{0xff, 0x01}, 
...
static struct sr352_regval  regs_res_recording_50Hz_30fps[] = {
