/* drivers/media/video/sr130pc20m_regs_1_1.h
 *
 * Driver for sr130pc20m (VGA Camera) from Siliconfile
 *
...
struct sr130pc20m_regval {
	u8 addr;
	u8 val;
};

#ifndef __EOSCAMERAsr130pc20m_REG_H
#define __EOSCAMERAsr130pc20m_REG_H

// Frame Auto
static struct sr130pc20m_regval regs_start_setting[]={
...
static struct sr130pc20m_regval regs_stop_stream[]={
{0x03, 0x00},
{0x01, 0x01},
{SR130PC20M_TERM, 0}
};

static struct sr130pc20m_regval regs_start_stream[]={
{0x03, 0x00},
{0x01, 0x00},
{SR130PC20M_TERM, 0}
};

static struct sr130pc20m_regval regs_res_1_3m[] ={
{0x03, 0x00},
{0x01, 0x01},/*sleep*/
...
static struct sr130pc20m_regval regs_res_auto_fps[] =
{
{0xFF, 0x00},  //END
{SR130PC20M_TERM, 0}
};
...
static struct sr130pc20m_regval sr130pc20m_fps_5_regs[] =
{
{0xFF, 0x00},  //END
{SR130PC20M_TERM, 0}
};
static struct sr130pc20m_regval sr130pc20m_fps_7_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},
...
static struct sr130pc20m_regval sr130pc20m_fps_10_regs[] =
{
{0xFF, 0x00},
{SR130PC20M_TERM, 0}
};

static struct sr130pc20m_regval sr130pc20m_fps_15_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},
...
static struct sr130pc20m_regval sr130pc20m_fps_20_regs[] =
{
{0xFF, 0x00},
{SR130PC20M_TERM, 0}
};
static struct sr130pc20m_regval sr130pc20m_fps_25_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},
...
static struct sr130pc20m_regval sr130pc20m_fps_30_regs[] =
{
{0xFF, 0x00},
{SR130PC20M_TERM, 0}
};
// Frame Fixed
static struct sr130pc20m_regval regs_res_vga_vt[] =
{
	/*0 Page*/
{0x03, 0x00},
{0x01, 0x01},	/*sleep*/
...
static struct sr130pc20m_regval sr130pc20m_init_regs_smart_stay[] = {
	/*0 Page*/
{0x03, 0x00},
{0x01, 0x01},	/*sleep*/
{0x01, 0x03},	/*s/w reset*/
...
{0x90, 0x0c}, /*BLC_TIME_TH_ON*/
{0x91, 0x0c}, /*BLC_TIME_TH_OFF */
{0x92, 0xf7}, /*BLC_AG_TH_ON*/
{0x93, 0xef}, /*BLC_AG_TH_OFF*/
...
{0xd4, 0x0c}, /*DCDC_TIME_TH_ON*/
{0xd5, 0x0c}, /*DCDC_TIME_TH_OFF */
{0xd6, 0xf7}, /*DCDC_AG_TH_ON*/
{0xd7, 0xef}, /*DCDC_AG_TH_OFF*/
...
{0x60, 0x6b},	/*out color sat en[7] | auto color decrement en[1] /
			  | manual color sat en[0]*/

{0x61, 0x83},	/*blue saturation_C0*/
{0x62, 0x80},	/*red saturation_B0*/

{0x63, 0xb0},	/*auto decresment on AG th*/
{0x64, 0xff},	/*auto decresment on DG th*/
{0x66, 0xe4},	/*Outdoor saturation step 137fps apply out th */
{0x67, 0x00},	/*Outdoor saturation B/R*/
{0x76, 0x01}, /* ADD 20121031 */
...
{0x42, 0x80},	/*dark1 H th*/
{0x43, 0x18},	/*dark1 L th*/
{0x44, 0x80},	/*dark1 gain ratio*/
{0x45, 0x0f},	/*dark1 H lum         38->28  */
{0x46, 0x0c},	/*dark1 M lum         27->17*/
{0x47, 0x0b},	/*dark1 L lum         20->1a */

{0x48, 0x80},	/*dark2 H th*/
{0x49, 0x18},	/*dark2 L th*/
{0x4a, 0x80},	/*dark2 gain ratio*/
{0x4b, 0x0f},	/*dark2 H lum */
{0x4c, 0x0c},	/*dark2 M lum*/
{0x4d, 0x0b},	/*dark2 L lum */

{0x4e, 0x80},	/*dark3 H th*/
{0x4f, 0x23},	/*dark3 L th*/
{0x50, 0x80},	/*dark3 gain ratio*/
{0x51, 0x1d},	/*dark3 H lum	*/
{0x52, 0x1f},	/*dark3 M lum */
{0x53, 0x1f},	/*dark3 L lum */
...
{0x5e, 0xa0},	/*dark3 H th*/
{0x5f, 0x1c},	/*dark3 L th*/
{0x60, 0x29},	/*dark3 H lum*/
{0x61, 0x4a},	/*dark3 M lum*/
{0x62, 0xff},	/*dark3 L lum*/
{0x63, 0xff},	/*dark3 ratio*/
...
{0x77, 0x81},
{0x78, 0x22}, /* 24*/
{0x79, 0x25}, /* Y Target 70 => 25, 72 => 26*/
{0x7a, 0x23}, /* 23*/
{0x7b, 0x22}, /* 22*/
{0x7d, 0x23},
...
{0x8D, 0x69}, /*EXP120 */
{0x8E, 0xbb}, 
{0x9c, 0x0a}, /*EXP Limit 1157.82 fps */
{0x9d, 0xf7}, 
{0x9e, 0x01}, /*EXP Unit*/ 
{0x9f, 0x91}, 
{0x98, 0x9d},
...
static struct sr130pc20m_regval regs_res_vga[] =
{
{0x03, 0x00},
{0x01, 0x01},/*sleep*/
...
static struct sr130pc20m_regval sr130pc20m_528_432_size_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},/*sleep*/
...
static struct sr130pc20m_regval sr130pc20m_352_288_size_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},/*sleep*/
...
static struct sr130pc20m_regval sr130pc20m_176_144_size_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},/*sleep*/
...
static struct sr130pc20m_regval sr130pc20m_320_240_size_regs[] =
{
{0x03, 0x00},
{0x01, 0x01},
...
#endif /* __EOSCAMERAsr130pc20m_REG_H */
