...
void thread_info_cache_init(void)
{
...
#if defined(CONFIG_THREADINFO_MEMPOOL)
	{
		...
		min_nr = (totalram_pages * 8 / 1000) / (THREAD_SIZE / PAGE_SIZE); /* 0.8% of totalpages */
		printk(" thread_info mempool reserved : %d \n", min_nr);
		
		thread_info_pool = mempool_create(min_nr, mempool_alloc_slab, mempool_free_slab, thread_info_cache);
