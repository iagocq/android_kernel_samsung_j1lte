...
#ifdef CONFIG_SEC_DEBUG
		print_ftrace("[pxa_cpu_idle] state: 0x%x cpu_id: %u cluster %u@",
...
TRACE_EVENT(pxa_core_clk_chg,
	...
	TP_fast_assign(
		...
		__entry->val2 = val2;
#ifdef CONFIG_SEC_DEBUG
		print_ftrace("[pxa_core_clk_chg] state: %u freq: %u -> %u@",
...
TRACE_EVENT(pxa_ddr_clk_chg,
	...
	TP_fast_assign(
		...
		__entry->val2 = val2;
#ifdef CONFIG_SEC_DEBUG
		print_ftrace("[pxa_ddr_clk_chg] state: %u freq: %u -> %u@",
			     __entry->state, __entry->val1, __entry->val2);
#endif
	),
...
TRACE_EVENT(pxa_axi_clk_chg,
	...
	TP_fast_assign(
		...
		__entry->val2 = val2;
#ifdef CONFIG_SEC_DEBUG
		print_ftrace("[pxa_axi_clk_chg] state: %u freq: %u -> %u@",
			     __entry->state, __entry->val1, __entry->val2);
#endif
	),
